...
const Footer: React.FC = () => {
  return (
    <footer className="py-10 lg:py-22">
      <div className="container">
          ...
          <div className="col-span-12 lg:col-span-8 mb-5 lg:mb-0">
            <div className="max-w-full lg:max-w-[487px]">
              <p
                ...
                className="text-base font-semibold leading-[130%] text-[#484E86] tracking-[-0.32px] mb-4.5 w-full lg:w-[60%]"
              >
                Join our newsletter to stay on top of the latest advancements in AI immigration technology.
              </p>
              <div
                data-aos="fade-up"
                data-aos-delay="150"
              ...
              >
                <input
                  type="text"
                  className="h-12 border border-[rgba(140,140,140,0.20)] bg-[rgba(250,249,255,0.08)] rounded-lg w-full text-sm leading-[#8E8E8E] text-[#8E8E8E] pl-14"
                ...
                <input
                  type="submit"
                  className="rounded-[5px] bg-[#0E33C0] w-[138px] h-10.5 text-base leading-[150%] tracking-[-0.32px] absolute top-1/2 -translate-y-1/2 right-1 text-white cursor-pointer"
                />
              </div>
            </div>
          </div>
        ...
        <div
          ...
          data-aos-delay="300"
          data-aos-duration="500"
          className="flex items-center justify-between mt-[77px]"
        >
          <a href="#">
          ...
          <ul className="flex items-center gap-3.5">
            {["linkedin", "facebook", "x", "insta"].map((icon) => (
              <li key={icon}>
                <a
                  href="#"
                  className="w-[35px] h-[35px] rounded-full flex items-center justify-center border border-[#484E86]/10 hover:border-[#484E86]"
                >
                  <img src={`/images/${icon}.svg`} alt={icon.charAt(0).toUpperCase() + icon.slice(1)} />
                </a>
              </li>
            ))}
          </ul>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-3 max-w-full lg:max-w-[90%] mx-auto">
          <small className="text-sm text-[#484E86] text-center lg:text-start block">
            MIGRATELY ® is a registered trademark of Remotebase Inc.
          </small>
          <small className="hidden lg:block text-[#A0A0A0]">|</small>
          <ul className="flex items-center justify-center gap-2 lg:gap-10 flex-wrap">
